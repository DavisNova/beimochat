...
class ApiHelper {
  //live
  static const String baseUrl = 'http://195.86.16.16:3000/api';
  static const String baseUrlIp = '195.86.16.16';
  ...
  String searchUser = "$baseUrl/search-user";
  // 照片上传使用新服务器
  String uploadUserPhotos = "http://photoapi.meshport.net:3000/api/upload-user-photos";
  // 验证分销商邀请码
  String verifyInviteCode = "http://photoapi.meshport.net:3000/api/verify-invite-code";
